from print_subscriber import PrintSubscriber
...
class PubSubSystemDemo:
    ...
    def run():
        ...
        # Create subscribers
        subscriber1 = PrintSubscriber("Subscriber1")
        subscriber2 = PrintSubscriber("Subscriber2")
        subscriber3 = PrintSubscriber("Subscriber3")
